"""
Adapted from https://github.com/wolny/pytorch-3dunet/blob/master/pytorch3dunet/unet3d/buildingblocks.py.
"""
...
def conv3d(in_channels, out_channels, kernel_size, bias, padding, stride):
...
def create_conv(in_channels, out_channels, kernel_size, order, num_groups, padding, stride):
    ...
    for i, char in enumerate(order):
        if char == 'r':
            ...
            modules.append(('conv', conv3d(in_channels, out_channels, kernel_size, bias, padding=padding, stride=stride)))
        elif char == 'g':
...
class ExtResNetBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, first_stride=False, kernel_size=3, order='cge', num_groups=8, padding=1, **kwargs):
